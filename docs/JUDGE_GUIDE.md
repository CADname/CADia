...
Open [`../evidence/README.md`](../evidence/README.md). It indexes 29 saved modeling examples with the exact prompt and available preview / STEP AP242 / STEP / STL / 3MF / 3D-print G-code artifacts.
